...
translator: Xie Yuheng <xyheme@gmail.com>
---

集体软件开发契约 (Collective Code Construction Contract (C4))
衍生于 github.com [分支 + 拉回 模型](https://help.github.com/articles/about-pull-requests/),
旨在为自由软件项目提供最优的合作模型.
